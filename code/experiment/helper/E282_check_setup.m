function E282_check_setup(exp)
% E282_check_setup
%%
pl_len = -200:100:700;                                                      % coordinates and size of the grid
figure, hold on
...
%         end            
    ...
    pause(.05)
%     hypot(curdata(1,1)-exp.pos.(posfields{cont_flag})(1),...            % when the distance to the center of the target position is less than radius we add to a counter
%              curdata(1,2)-exp.pos.(posfields{cont_flag})(2))
